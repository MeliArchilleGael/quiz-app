...
INSERT INTO "new_Question" ("categoryId", "created_at", "durationInSeconds", "id", "mediaLink", "multipleChoice", "questionType", "subjectId", "title", "updated_at") SELECT "categoryId", "created_at", "durationInSeconds", "id", "mediaLink", "multipleChoice", "questionType", "subjectId", "title", "updated_at" FROM "Question";
DROP TABLE "Question";
